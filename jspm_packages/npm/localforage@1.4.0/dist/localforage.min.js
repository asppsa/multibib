  ...
  !function() {
    ...
    return function(a) {
      ...
      var c = function(a) {
        function b(b, c) {
          ...
          try {
            ...
            if ("TypeError" !== d.name)
              throw d;
            for (var e = a.BlobBuilder || a.MSBlobBuilder || a.MozBlobBuilder || a.WebKitBlobBuilder,
                f = new e,
                g = 0; g < b.length; g += 1)
              f.append(b[g]);
      ...
      var d = function(a) {
          ...
          var b = this,
              c = b.ready().then(function() {
                for (var a = b._dbInfo,
                    ...
                    d = [],
                    e = 0; c > e; e++)
                  0 === m.key(e).indexOf(a.keyPrefix) && d.push(m.key(e).substring(a.keyPrefix.length));
                return d;
              });
          return l(c, a), c;
        }
        ...
        var m = null;
        try {
          if (!(a.localStorage && "setItem" in a.localStorage))
            return;
          m = a.localStorage;
        } catch (n) {
          return;
